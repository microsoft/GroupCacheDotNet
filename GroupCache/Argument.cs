...
namespace GroupCache
{
    public static class Argument
    {
        ...
        public static void Requires<TException>(bool condition, string what) where TException : Exception, new()
        {
            if (!condition)
            {
        ...
        [Conditional("DEBUG")]
        public static void RequiresDebugOnly<TException>(bool condition) where TException : Exception, new()
        {
            Requires<TException>(condition);
        }

        [Conditional("DEBUG")]
        public static void RequiresDebugOnly<TException>(bool condition, string what) where TException : Exception, new()
        {
